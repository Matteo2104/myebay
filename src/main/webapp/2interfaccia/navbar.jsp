        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <c:forEach items="${userInfo.ruoli}" var="ruolo" >
				...
				<c:if test="${empty userInfo}" >
            			...
            			<a class="nav-link active text-white" href="login.jsp">Login</a>
     			...
     			<c:if test="${not empty userInfo}" >
					<span class="navbar-text">
            			Utente: ${userInfo.username} (${userInfo.nome } ${userInfo.cognome})
          				...
          				<a class="nav-link active text-white" href="${pageContext.request.contextPath}/areapersonale.jsp">Area Personale</a>
